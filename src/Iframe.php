 ...
 \ \ '__`\  /'__`\  /'__`\  /\ \/\ \\ \ \/ /\ \/\ \      / __`\\ \ ,__\      \ \ \    / __`\ /\ \/\ \  /'__`\
  \ \ \L\ \/\  __/ /\ \L\.\_\ \ \_\ \\ \ \_\ \ \_\ \    /\ \L\ \\ \ \_/       \_\ \_ /\ \L\ \\ \ \_/ |/\  __/
    ...
    */
    ...
    {
        $id = self::getID($url);
        $str = '<iframe width="560" height="315" src="https://www.youtube.com/embed/'.$id.'" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" '.self::$fscreen.' '.self::$attributes.'  style=" '.Iframe::$css.'"></iframe>';
        return $str;
    }
